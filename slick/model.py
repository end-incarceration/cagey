...
class ReloadableSession(object):
    ...
    def __init__(self, db_filename):
        ...
        self.session = sqlalchemy.orm.sessionmaker(bind=get_engine(self.db_filename))
